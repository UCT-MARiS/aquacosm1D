...
for tau_mean in tau_means:
    for Qswmax in Qswmaxs:
        ...
        #print(z_therm) 
        for n in range(1,3):
            ax[n].plot(time_croco,z_therm_croco)
            ax[n].contour(time_croco,z_croco,temp_croco,[11],colors='w',linewidths=2.5,linestyles='dashed') #kept here for comparison with previous hardcoded thermocline depth determination
        ...
        ax[3].set_ylim(0,kappa_croco_surf.max())
