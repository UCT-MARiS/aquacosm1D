...
ps = [1.e-4, 1.e-7] # [1.e-3, 1.e-5, 1.e-7, 1.e-9, 1.e-12]
...
for mld in mlds:
    for kappa in kappas:
        for p in ps:
            ...
            fname_out='aquacosm_p'+"{0:1.0e}".format(Diffuse.p)+'_'+react_params.Name+'_r'+str(react_params.BasePhotoRate)+"_mld"+str(mld)+"_kappa"+str(kappa)+'_dt'+str(dt)+".nc"
